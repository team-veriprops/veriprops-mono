"""The WhatsApp bot (PRD §26.6) — the conversation layer over the same backend.
...
(§26.3.4, what this surface offers at all), `content` (every word, code-owned), `projection`
(§26.3.2 stage names derived from the real status machine), and `flows/` (pure branching
