...
* ``HANDOFF`` — the customer finishes on veriprops.ng through a §26.5 single-use link.
...
# The WhatsApp column of §26.3.4. The website column is `FULL` for every row except the
...
# Which §26.5 link a handoff action needs. Every `HANDOFF` row must appear here, or the
