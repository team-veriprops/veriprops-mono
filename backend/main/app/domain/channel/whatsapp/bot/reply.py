...
is what lets the §7.6.4 adversarial suite assert on copy and routing without a transport,
...
normal, successful outcome — §7.6.2 lists three ways to reach it by design.
"""
