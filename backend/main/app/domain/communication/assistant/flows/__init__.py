"""Assistant conversation flows (PRD §26.6.2).
...
dashboard reads, because the flow had no other way to get it. Flows only one surface runs
live with that surface (WhatsApp's media flow is in `channel/whatsapp/bot/flows/`).
"""
from main.app.domain.communication.assistant.flows import handoff  # noqa: F401
from main.app.domain.communication.assistant.flows import intake  # noqa: F401
from main.app.domain.communication.assistant.flows import status  # noqa: F401
