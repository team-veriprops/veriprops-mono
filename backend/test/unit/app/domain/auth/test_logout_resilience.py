...
success and failure alike. With nothing valid to revoke (an expired or missing token) logout
simply succeeds. When the revocation itself fails (the device row or the denylist write),
