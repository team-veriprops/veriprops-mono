...
const socialHoverClasses: Record<string, string> = {
  ...
  TikTok:    "hover:text-social-tiktok hover:border-social-tiktok/40 hover:bg-social-tiktok/10",
};
                ...
                if (!configured) {
                  return (
                    <span
                      ...
                      aria-disabled="true"
                      className={cn(baseClass, socialHoverClasses[social.label], "opacity-50 cursor-default")}
                    >
